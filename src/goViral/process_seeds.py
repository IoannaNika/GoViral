...
def main():
    ...
    parser.add_argument('--coverage', dest = 'coverage', default=10, required=False, type=int, help="")
    parser.add_argument('--seed_limit', dest = 'seed_limit', required=True, type=int, help="")
